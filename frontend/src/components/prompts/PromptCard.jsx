...
export default function PromptCard({ prompt, onEdit, onDelete, onDuplicate, onCopy, onFavoriteToggle, onTagClick, onHistory, selected = false, onSelect }) {
  ...
  return (
    <>
      <motion.div
        className="group/card flex flex-col bg-white dark:bg-[#252733]
          border border-[#E5E7EB] dark:border-[#363847] rounded-xl
          hover:border-[#714B67] hover:shadow-[0_4px_16px_-4px_rgba(113,75,103,0.15)] transition-colors duration-200 overflow-hidden"
        whileHover={{ y: -2 }}
      ...
      >
        ...
        <div className="flex flex-col gap-3.5 p-5">
          ...
          <div className="flex items-center gap-1.5 flex-wrap pt-2.5 border-t border-[#E5E7EB] dark:border-[#363847]">
            <ActionBtn onClick={handleCopy} active={copied && !hasVariables} accent={!copied || hasVariables}>
              {copied && !hasVariables
